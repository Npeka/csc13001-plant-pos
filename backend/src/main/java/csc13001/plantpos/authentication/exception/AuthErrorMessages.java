...
public class AuthErrorMessages {
    ...
    public static final String INVALID_PASSWORD = "Mật khẩu không khớp.";
    public static final String INVALID_CONFIRM_PASSWORD = "Mật khẩu và xác nhận mật khẩu không khớp.";
